"""
Cross-Language MLM Evaluation for UniXcoder
Evaluates the UniXcoder-cpp model on original training languages:
...
# ============================================================================
# UniXcoder Evaluator (Simple - No DFG)
# ============================================================================
...
class UniXcoderEvaluator:
    ...
    def evaluate_language(self, language: str, snippets: List[str],
        ...
        for idx, code in enumerate(tqdm(snippets, desc=f"Evaluating {language}")):
            ...
            # Simple UniXcoder input (no DFG attention mask)
...
def save_results(all_results: Dict[str, Dict]):
    ...
    with open(summary_file, 'w', encoding='utf-8') as f:
        f.write("=" * 80 + "\n")
        f.write("CROSS-LANGUAGE MLM EVALUATION: UniXcoder-cpp\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    print("\n" + "=" * 80)
    print("CROSS-LANGUAGE MLM EVALUATION: UniXcoder-cpp")
    print("=" * 80)
    ...
    evaluator = UniXcoderEvaluator(MODEL_PATH, tokenizer)
